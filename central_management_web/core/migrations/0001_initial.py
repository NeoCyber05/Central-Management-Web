# Generated by Django 4.2.21 on 2025-05-31 07:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='schedule',
            name='class_obj',
            field=models.ForeignKey(db_column='class_id', on_delete=django.db.models.deletion.CASCADE, related_name='schedules', to='core.clazz', verbose_name='Lớp học'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='feedback',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('class_rate__gte', 0), ('class_rate__lte', 10)), ('class_rate__isnull', True), _connector='OR'), name='class_rate_in_range'),
        ),
        migrations.AddConstraint(
            model_name='feedback',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('teacher_rate__gte', 0), ('teacher_rate__lte', 10)), ('teacher_rate__isnull', True), _connector='OR'), name='teacher_rate_in_range'),
        ),
        migrations.AddConstraint(
            model_name='enrollments',
        ...
        migrations.AddConstraint(
            model_name='attendance',
            constraint=models.CheckConstraint(check=models.Q(('status__in', ['Absent', 'Present'])), name='status_valid'),
        ),
    ]
